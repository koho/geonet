...
func (b *bindOut) FormatGeoIP(c *gin.Context, cidrs []*router.CIDR, countryCode string) error {
	return lib.ErrNotImplemented
}

func (b *bindOut) FormatGeoSite(c *gin.Context, domains []*router.Domain, countryCode string) error {
