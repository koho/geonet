...
func (cd *coreDnsOut) FormatGeoIP(c *gin.Context, cidrs []*router.CIDR, countryCode string) error {
	return lib.ErrNotImplemented
}

func (cd *coreDnsOut) FormatGeoSite(c *gin.Context, domains []*router.Domain, countryCode string) error {
