...
func (d *dnsmasqOut) FormatGeoIP(c *gin.Context, cidrs []*router.CIDR) (string, error) {
	return "", lib.ErrNotImplemented
}

func (d *dnsmasqOut) FormatGeoSite(c *gin.Context, domains []*router.Domain) (string, error) {
